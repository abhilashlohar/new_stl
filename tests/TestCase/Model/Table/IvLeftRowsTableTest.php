...
use App\Model\Table\IvLeftRowsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\IvLeftRowsTable Test Case
 */
class IvLeftRowsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\IvLeftRowsTable
     */
    public $IvLeftRows;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('IvLeftRows') ? [] : ['className' => 'App\Model\Table\IvLeftRowsTable'];
        $this->IvLeftRows = TableRegistry::get('IvLeftRows', $config);
    }
