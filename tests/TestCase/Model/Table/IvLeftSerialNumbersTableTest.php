...
use App\Model\Table\IvLeftSerialNumbersTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\IvLeftSerialNumbersTable Test Case
 */
class IvLeftSerialNumbersTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\IvLeftSerialNumbersTable
     */
    public $IvLeftSerialNumbers;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('IvLeftSerialNumbers') ? [] : ['className' => 'App\Model\Table\IvLeftSerialNumbersTable'];
        $this->IvLeftSerialNumbers = TableRegistry::get('IvLeftSerialNumbers', $config);
    }
    ...
    {
        unset($this->IvLeftSerialNumbers);
