...
use App\Model\Table\IvRightSerialNumbersTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\IvRightSerialNumbersTable Test Case
 */
class IvRightSerialNumbersTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\IvRightSerialNumbersTable
     */
    public $IvRightSerialNumbers;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('IvRightSerialNumbers') ? [] : ['className' => 'App\Model\Table\IvRightSerialNumbersTable'];
        $this->IvRightSerialNumbers = TableRegistry::get('IvRightSerialNumbers', $config);
    }
    ...
    {
        unset($this->IvRightSerialNumbers);
